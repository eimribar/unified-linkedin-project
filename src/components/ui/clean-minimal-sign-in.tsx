...
import { LogIn, Lock, Mail, Linkedin } from "lucide-react";
...
const SignIn2 = () => {
  ...
  const handleSignIn = async () => {
    ...
    setTimeout(() => {
      signUp(email);
      toast.success("Welcome back! Let's continue your content journey");
      navigate('/welcome');
      setIsLoading(false);
    }, 1000);
  };
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-transparent rounded-xl z-1">
      <div className="w-full max-w-sm bg-gradient-to-b from-sky-50/50 to-white dark:from-zinc-900/50 dark:to-zinc-900 rounded-3xl shadow-xl shadow-opacity-10 p-8 flex flex-col items-center border border-blue-100 dark:border-zinc-800 text-black dark:text-white">
        ...
        <p className="text-gray-500 dark:text-gray-400 text-sm mb-6 text-center">
          Access your personalized LinkedIn content portal and continue creating
        </p>
        <div className="w-full flex flex-col gap-3 mb-2">
          <div className="relative">
            ...
            <input
              ...
              type="email"
              value={email}
              className="w-full pl-10 pr-3 py-2 rounded-xl border border-gray-200 dark:border-zinc-700 focus:outline-none focus:ring-2 focus:ring-blue-200 dark:focus:ring-blue-900 bg-gray-50 dark:bg-zinc-800 text-black dark:text-white text-sm"
          ...
          <div className="relative">
            ...
            <input
              ...
              type="password"
              value={password}
              className="w-full pl-10 pr-10 py-2 rounded-xl border border-gray-200 dark:border-zinc-700 focus:outline-none focus:ring-2 focus:ring-blue-200 dark:focus:ring-blue-900 bg-gray-50 dark:bg-zinc-800 text-black dark:text-white text-sm"
